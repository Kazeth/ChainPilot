    ...
    <footer className="bg-zinc-900 border-t border-zinc-800 pt-12 pb-8 overflow-x-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
        ...
        <div className="flex space-x-6 mb-8">
          <a href="#" className="text-zinc-500 hover:text-[#87efff] transition-colors duration-300"><InstagramIcon /></a>
          <a href="#" className="text-zinc-500 hover:text-[#87efff] transition-colors duration-300"><GithubIcon /></a>
          <a href="#" className="text-zinc-500 hover:text-[#87efff] transition-colors duration-300"><LinkedinIcon /></a>
        </div>

        {/* 3. Endless Looping Marquee */}
        {/* For this animation to work, you need to define the 'marquee' keyframes in your global CSS file (e.g., index.css) */}
        <div className="relative w-full h-12 flex items-center justify-center overflow-hidden mb-8">

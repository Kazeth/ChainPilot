    ...
    <div className="px-4 sm:px-6 lg:px-8">
      ...
      <section className="py-16 md:py-24 text-center">
        ...
        <p className="max-w-3xl mx-auto text-zinc-400">
          ChainPilot is a next-generation crypto application that empowers you to navigate the digital asset market with
          unparalleled intelligence and security. We provide a seamless platform that integrates AI-driven trade
          signals, disciplined risk management, and a pioneering feature to secure your assets for the future.
        </p>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Card className="text-center">
            ...
            <p className="mt-2 text-zinc-400">
              Our advanced AI analyzes thousands of data points to provide clear, actionable intelligence on what to buy
              and when to trade.
            </p>
          </Card>
          <Card className="text-center">
            ...
            <p className="mt-2 text-zinc-400">
              Set your rules once and let ChainPilot manage your positions, protecting your capital and securing profits
              24/7.
            </p>
          </Card>
          <Card className="text-center">
            ...
            <p className="mt-2 text-zinc-400">
              Our groundbreaking protocol ensures your digital assets can be safely passed on to your chosen
              beneficiary.
            </p>
          </Card>
        </div>
